...
g++ -o keygen-perf keygen-perf.cc -O3 -L ../../cuda/lib -lpqcrystals_kyber768_cuda -L ../../ref/kyber/avx2 -lpqcrystals_kyber768_avx2 -lpqcrystals_fips202_avx2 -lpqcrystals_fips202x4_avx2 -L ../../ref/kyber/ref/lib -lpqcrystals_kyber768_ref -lpqcrystals_fips202_ref -std=c++17
